...
class ProfilerReporter {
    ...
    public synchronized void reportFieldsDom(final FieldsDom fieldsDom) {
        this.dos.writeByte(ControlId.REPORT_FIELDS_DOM);
        this.dos.write(fieldsDom);
        this.dos.flush();
    }

    public synchronized void reportFieldAccesses(final ArrayList<Integer> accessedFieldCodes) {
        this.dos.writeByte(ControlId.REPORT_FIELD_ACCESSES);
        this.dos.write(accessedFieldCodes);
        this.dos.flush();
    }
}